...
md`# 結論
1. 在此問卷當中，大多數的工作地點為工作室，且在工作室中主要以減少包裝材料、文宣印製、使用再生材料及節約能源等方式來減少碳排放量。
2. 問卷中也可看出代替空間占比比非營利團體與藝術團體來的稍多一點，這代表空間靈活及可塑性可能更受藝術家歡迎。`
)}
...
d3
  ...
  .range(["#B5CAA0","#FBE251","#DC9FB4","#FB9966","#D0104C","#7DB9DE"])
  .unknown("#FEDFE1")
)}
