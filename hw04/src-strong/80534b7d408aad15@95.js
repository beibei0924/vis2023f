...
function _chart(d3,data)
{
  ...
  const color = d3.scaleOrdinal(d3.quantize(d3.interpolate("#FB9966","blue",), data.children.length + 1));
...
md`# 結論
從上圖可看出: 
1. 此問卷大多是居住於北部的人填寫的，次之為南部，中部與東部則偏少。
2. 西部地區的人比較多都是採取減少包裝材及文宣印製來減少碳排放量。
3. 所有填問卷的人使用減少碳排放的方式多為減少包裝材及文宣印製、使用無毒媒材、再生材料、廢物利用素材、工作場所、活動展場的節約能源以及減少商務差旅等方式。`
)}
